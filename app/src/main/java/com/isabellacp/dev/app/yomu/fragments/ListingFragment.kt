package com.isabellacp.dev.app.yomu.fragments
...
import com.isabellacp.dev.app.yomu.adapter.ItemPagedAdapter
import com.isabellacp.dev.app.yomu.databinding.FragmentListingBinding
...
class ListingFragment() : Fragment() {
    ...
    override fun onCreateView(
        ...
        when (listingType) {
            ListingType.ANIME.toString() -> loadAnimeData()

            ListingType.LIBRARY.toString() -> showLibrary()
